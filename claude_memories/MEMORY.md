...
- [Not trading off this system](not-trading-off-this-system.md) — user directive: stop framing work around "before you trade real money"; nothing is traded off this
...
- [A pin at zero needs a producer](pin-at-zero-needs-a-producer.md) — a test that something never happens proves nothing if no code path can make it happen; name the producer being observed
