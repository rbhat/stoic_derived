...
- [WP-V §3.2 extraction run](wpv-32-extraction-run.md) — **active run.** How to check/resume it (`--status`, re-run `scripts/wpv32_run.sh`), the measured rates that replace the plan's 16.9 h, the axis-furniture decision, and the 2–3 h sanity check
