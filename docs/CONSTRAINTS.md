...
| The human-review gate ADR-0004 requires is **unresolved decision 12, `primary-evidence-review`**. Until it is defined, nothing mined becomes a validated rule. Resolve it before the other eleven. | `strategy/rulebook.yaml`, `docs/notes/2026-07-27-spec-coverage-probe.md` §3 |
