...
| Decide which bar the entry order sits on | `docs/RULEBOOK.md` — §5.3.3a (what a correction bar *is*), §5.3.4–§5.3.6 (no bar cap; the order re-anchors), §5.2.8 (an inside bar is never the anchor) |
